(ns lib.api.middleware
 (:require
    [geo.spatial                            :as spatial :refer [spal4j-point distance circle intersects?]]
    [clj-time.core                          :as t]
    ...
    [lib.graph               :as g       :refer [vertices->edges intra]]
    [lib.graph.google              :as graph]
    [lib.capacity-cluster          :as cc]
    [lib.ant-colony                :as ac]
    [lib.solution                  :as sol]
    [lib.time-window        :as twin]
    [lib.core                   :as core    :refer [gfn wfn graph-logger]]
    [lib.common.data                   :as d]
    [lib.common.util                   :as u       :refer [safe-nth safe-add multiparse]]
    [lib.common.config                 :as cfg     :refer [ant-colony-trials google-options]]))
